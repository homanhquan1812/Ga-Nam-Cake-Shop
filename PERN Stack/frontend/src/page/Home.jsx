  ...
  return (
    <div>
      <Head
        ...
        additionalTitle={["Home - Gà Nấm Cake Shop"]}
      ></Head>
      <Header></Header>
      {/* CAROUSEL  */}
      {/* <section class="cover">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              ...
              <div className="carousel-caption container">
                <h1
                  style={{ color: "red", fontSize: "100px", fontWeight: 700 }}
                >
                  BAKERY
                </h1>
                <p
                  className="carousel-first"
                  style={{
                    fontSize: "20px",
                    fontWeight: 700,
                    background: "white",
                    borderRadius: "20px",
                    border: "10px solid",
                    borderImage: "linear-gradient(45deg, red, blue) 10",
                    borderImageSlice: 1,
                  }}
                >
                  A delicious variety of sweet and savory pastries and donuts,
            ...
            */}
            <div className="carousel-item">
              ...
              <div className="carousel-caption container">
                <h1>COMMENTS</h1>
                <p>
                  Thank you for your interest in reaching out to us! Fill out
                  the feedback form and a member of our team will be in touch
                  soon.
                </p>
      ...
      <section className="services" id="services">
        ...
        <div className="services__content">
          <div className="services__item">
            ...
            <h3>Tasty cakes</h3>
            <p>
              Joy baked into every bite. Enjoy fresh pastries, warm breads, our
          ...
          <div className="services__item">
            ...
            <h3>Occasion</h3>
            <p>
              We bring our best to every task, poring over details and never
              doing anything halfway or in haste.
            </p>
            {/* <button class="button-pink">Learn more</button> */}
          </div>
          <div className="services__item">
            ...
            <h3>Spread Joy</h3>
            <p>
              The desire to make the world a happier place drives everything we
              do.
            </p>
            {/* <button class="button-pink">Learn more</button> */}
          </div>
          <div className="services__item">
            ...
            <h3>Community</h3>
            <p>
              Fostering connections, building community and making people’s days
              a little brighter, any way we can.
            </p>
            {/* <button class="button-pink">Learn more</button> */}
          </div>
        </div>
      ...
      <section className="service__carousel" style={{ marginTop: "-100px" }}>
        <div id="carouselCyber" className="carousel slide">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img
                src="./img/368393066_2092635904435757_2978394674549760427_n.jpg"
                className="d-block w-100 "
                alt="..."
              />
              <div className="container carousel-caption">
                <h1>Order Now</h1>
                <p>
                  Depending on the type of product, we can deliver it
                  fresh,part-baked or frozen.
                </p>
                <button className="btn">
                  <a href="/gallery">More product</a>
                  <i className="fa fa-angle-double-right" />
                </button>
              </div>
            </div>
            <div className="carousel-item">
              <img
                src="./img/371537875_646770300861892_8602497452080053974_n.jpg"
                className="d-block w-100"
                alt="..."
              />
            </div>
      ...
      <section className="feedback" id="clients">
        ...
        <div className="feedback__content">
          <div className="owl-carousel owl-theme">
            ...
            <div className="item">
              <p>
                <i className="fa fa-quote-left" />I love all the baked goods
                here, they also have cheese cakes!{" "}
            ...
            <div className="item">
              <p>
                ...
                Delicious many kinds of cakes, fast services. The price is
                affordable, the design is beautiful and suitable for giving as a
                gift. <i className="fa fa-quote-right" />
              </p>
              <p className="feedback__name">Huyen Pham</p>
            </div>
            <div className="item">
              <p>
                <i className="fa fa-quote-left" /> This is a small online shop
