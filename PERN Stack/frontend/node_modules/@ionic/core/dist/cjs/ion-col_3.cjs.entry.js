...
const Col = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c37fa4c4c993385ccbb6f4e89b2f390b140507a0', class: {
                [mode]: true,
            }, style: Object.assign(Object.assign(Object.assign(Object.assign({}, this.calculateOffset(isRTL)), this.calculatePull(isRTL)), this.calculatePush(isRTL)), this.calculateSize()) }, index.h("slot", { key: '6a5296ff0b9dee6600c2dafe7363a065d053bac2' })));
    }
};
...
const Row = class {
    ...
    render() {
        return (index.h(index.Host, { key: '813c9a7f6782d2cf8eb27f30d3ab28e6f3122868', class: ionicGlobal.getIonMode(this) }, index.h("slot", { key: '356bec4d4d408ea63d6b431b06465d5b7bcbff71' })));
    }
};
