...
const Toggle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b0d648e071bc8095998b519ce4dcdd0ea91575c0', onClick: this.onClick, class: theme.createColorClasses(color, {
                [mode]: true,
                ...
                [`toggle-${rtl}`]: true,
            }) }, index.h("label", { key: '9a2fe1d16dba66a9dfef450efebf2e5cbe3dcd00', class: "toggle-wrapper" }, index.h("input", Object.assign({ key: '4358d18cb86da768155c17f9da3aac641296c256', type: "checkbox", role: "switch", "aria-checked": `${checked}`, checked: checked, disabled: disabled, id: inputId, onFocus: () => this.onFocus(), onBlur: () => this.onBlur(), ref: (focusEl) => (this.focusEl = focusEl) }, this.inheritedAttributes)), index.h("div", { key: '0ec99e452164d7059cc4f93d09e5b918f82c022a', class: {
                'label-text-wrapper': true,
                'label-text-wrapper-hidden': !this.hasLabel,
            }, part: "label" }, index.h("slot", { key: '1c5cbc99905a79e842e9487eb3ca654e1bab3c66' })), index.h("div", { key: 'ca8196423b429899febd11c7337d768ff05df6f4', class: "native-wrapper" }, this.renderToggleControl()))));
    }
