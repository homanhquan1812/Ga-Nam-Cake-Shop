 ...
 */System.register(["./p-25180df3.system.js","./p-3ad285e3.system.js","./p-ff4b7e40.system.js","./p-4609d030.system.js","./p-a69b9fc5.system.js","./p-f687573e.system.js"],(function(e){"use strict";var t,n,i,r,a,o,s,c,d,u,f,l,b,p;return{setters:[function(e){t=e.r;n=e.h;i=e.f;r=e.i},function(e){a=e.a;o=e.c},function(e){s=e.a},function(e){c=e.c},function(e){d=e.b},function(e){u=e.s;f=e.x;l=e.L;b=e.N;p=e.M}],execute:function(){var m=":host{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center}:host button{border-radius:8px;-webkit-margin-start:2px;margin-inline-start:2px;-webkit-margin-end:2px;margin-inline-end:2px;margin-top:0px;margin-bottom:0px;position:relative;-webkit-transition:150ms color ease-in-out;transition:150ms color ease-in-out;border:none;background:var(--ion-color-step-300, var(--ion-background-color-step-300, #edeef0));color:var(--ion-text-color, #000);font-family:inherit;font-size:1rem;cursor:pointer;overflow:hidden;-webkit-appearance:none;-moz-appearance:none;appearance:none}:host(.time-active) #time-button,:host(.date-active) #date-button{color:var(--ion-color-base)}:host(.datetime-button-disabled){pointer-events:none}:host(.datetime-button-disabled) button{opacity:0.4}:host button{-webkit-padding-start:13px;padding-inline-start:13px;-webkit-padding-end:13px;padding-inline-end:13px;padding-top:7px;padding-bottom:7px}:host button.ion-activated{color:var(--ion-color-step-600, var(--ion-text-color-step-400, #666666))}";var h=m;var v=":host{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center}:host button{border-radius:8px;-webkit-margin-start:2px;margin-inline-start:2px;-webkit-margin-end:2px;margin-inline-end:2px;margin-top:0px;margin-bottom:0px;position:relative;-webkit-transition:150ms color ease-in-out;transition:150ms color ease-in-out;border:none;background:var(--ion-color-step-300, var(--ion-background-color-step-300, #edeef0));color:var(--ion-text-color, #000);font-family:inherit;font-size:1rem;cursor:pointer;overflow:hidden;-webkit-appearance:none;-moz-appearance:none;appearance:none}:host(.time-active) #time-button,:host(.date-active) #date-button{color:var(--ion-color-base)}:host(.datetime-button-disabled){pointer-events:none}:host(.datetime-button-disabled) button{opacity:0.4}:host button{-webkit-padding-start:12px;padding-inline-start:12px;-webkit-padding-end:12px;padding-inline-end:12px;padding-top:6px;padding-bottom:6px}";var x=v;var y=e("ion_datetime_button",function(){function e(e){var n=this;t(this,e);this.datetimeEl=null;this.overlayEl=null;this.getParsedDateValues=function(e){if(e===undefined||e===null){return[]}if(Array.isArray(e)){return e}return[e]};this.setDateTimeText=function(){var e,t,i,r,a;var o=n,c=o.datetimeEl,d=o.datetimePresentation;if(!c){return}var m=c.value,h=c.locale,v=c.formatOptions,x=c.hourCycle,y=c.preferWheel,g=c.multiple,w=c.titleSelectedDatesFormatter;var k=n.getParsedDateValues(m);var _=u(k.length>0?k:[f()]);if(!_){return}var j=_[0];var O=l(h,x);n.dateText=n.timeText=undefined;switch(d){case"date-time":case"time-date":var I=b(h,j,(e=v===null||v===void 0?void 0:v.date)!==null&&e!==void 0?e:{month:"short",day:"numeric",year:"numeric"});var E=p(h,j,O,v===null||v===void 0?void 0:v.time);if(y){n.dateText="".concat(I," ").concat(E)}else{n.dateText=I;n.timeText=E}break;case"date":if(g&&k.length!==1){var D="".concat(k.length," days");if(w!==undefined){try{D=w(k)}catch(e){s("Exception in provided `titleSelectedDatesFormatter`: ",e)}}n.dateText=D}else{n.dateText=b(h,j,(t=v===null||v===void 0?void 0:v.date)!==null&&t!==void 0?t:{month:"short",day:"numeric",year:"numeric"})}break;case"time":n.timeText=p(h,j,O,v===null||v===void 0?void 0:v.time);break;case"month-year":n.dateText=b(h,j,(i=v===null||v===void 0?void 0:v.date)!==null&&i!==void 0?i:{month:"long",year:"numeric"});break;case"month":n.dateText=b(h,j,(r=v===null||v===void 0?void 0:v.time)!==null&&r!==void 0?r:{month:"long"});break;case"year":n.dateText=b(h,j,(a=v===null||v===void 0?void 0:v.time)!==null&&a!==void 0?a:{year:"numeric"});break}};this.waitForDatetimeChanges=function(){return __awaiter(n,void 0,void 0,(function(){var e;return __generator(this,(function(t){e=this.datetimeEl;if(!e){return[2,Promise.resolve()]}return[2,new Promise((function(t){a(e,"ionRender",t,{once:true})}))]}))}))};this.handleDateClick=function(e){return __awaiter(n,void 0,void 0,(function(){var t,n,i,r,a;return __generator(this,(function(o){t=this,n=t.datetimeEl,i=t.datetimePresentation;if(!n){return[2]}r=false;switch(i){case"date-time":case"time-date":a=n.presentation!=="date";if(!n.preferWheel&&a){n.presentation="date";r=true}break}this.selectedButton="date";this.presentOverlay(e,r,this.dateTargetEl);return[2]}))}))};this.handleTimeClick=function(e){var t=n,i=t.datetimeEl,r=t.datetimePresentation;if(!i){return}var a=false;switch(r){case"date-time":case"time-date":var o=i.presentation!=="time";if(o){i.presentation="time";a=true}break}n.selectedButton="time";n.presentOverlay(e,a,n.timeTargetEl)};this.presentOverlay=function(e,t,i){return __awaiter(n,void 0,void 0,(function(){var n;return __generator(this,(function(r){switch(r.label){case 0:n=this.overlayEl;if(!n){return[2]}if(!(n.tagName==="ION-POPOVER"))return[3,3];if(!t)return[3,2];return[4,this.waitForDatetimeChanges()];case 1:r.sent();r.label=2;case 2:n.present(Object.assign(Object.assign({},e),{detail:{ionShadowTarget:i}}));return[3,4];case 3:n.present();r.label=4;case 4:return[2]}}))}))};this.datetimePresentation="date-time";this.dateText=undefined;this.timeText=undefined;this.datetimeActive=false;this.selectedButton=undefined;this.color="primary";this.disabled=false;this.datetime=undefined}e.prototype.componentWillLoad=function(){return __awaiter(this,void 0,void 0,(function(){var e,t,n,i;var r=this;return __generator(this,(function(c){e=this.datetime;if(!e){s("An ID associated with an ion-datetime instance is required for ion-datetime-button to function properly.",this.el);return[2]}t=this.datetimeEl=document.getElementById(e);if(!t){s("No ion-datetime instance found for ID '".concat(e,"'."),this.el);return[2]}if(t.tagName!=="ION-DATETIME"){s("Expected an ion-datetime instance for ID '".concat(e,"' but received '").concat(t.tagName.toLowerCase(),"' instead."),t);return[2]}n=new IntersectionObserver((function(e){var t=e[0];r.datetimeActive=t.isIntersecting}),{threshold:.01});n.observe(t);i=this.overlayEl=t.closest("ion-modal, ion-popover");if(i){i.classList.add("ion-datetime-button-overlay")}o(t,(function(){var e=r.datetimePresentation=t.presentation||"date-time";r.setDateTimeText();a(t,"ionValueChange",r.setDateTimeText);switch(e){case"date-time":case"date":case"month-year":case"month":case"year":r.selectedButton="date";break;case"time-date":case"time":r.selectedButton="time";break}}));return[2]}))}))};e.prototype.render=function(){var e;var t=this;var r=this,a=r.color,o=r.dateText,s=r.timeText,u=r.selectedButton,f=r.datetimeActive,l=r.disabled;var b=d(this);return n(i,{key:"0be955404133adbb31ae16a6599014bb29765f19",class:c(a,(e={},e[b]=true,e["".concat(u,"-active")]=f,e["datetime-button-disabled"]=l,e))},o&&n("button",{key:"812dcb50b17768cc13a5cfa0bcce8b113cee0f09",class:"ion-activatable",id:"date-button","aria-expanded":f?"true":"false",onClick:this.handleDateClick,disabled:l,part:"native",ref:function(e){return t.dateTargetEl=e}},n("slot",{key:"46930c740a32a78502df9e651f9bd5914d6a9fea",name:"date-target"},o),b==="md"&&n("ion-ripple-effect",{key:"0602999cc8435dc37aa22da7f5531bc8cb71e1b4"})),s&&n("button",{key:"ecdd21da5181ecbdce03209f9f6673b7dcbc1f78",class:"ion-activatable",id:"time-button","aria-expanded":f?"true":"false",onClick:this.handleTimeClick,disabled:l,part:"native",ref:function(e){return t.timeTargetEl=e}},n("slot",{key:"b5b093b5166d12d11e27360788edaac916d44390",name:"time-target"},s),b==="md"&&n("ion-ripple-effect",{key:"70bb3a04f4748d13233eeb257503968dbd1161a9"})))};Object.defineProperty(e.prototype,"el",{get:function(){return r(this)},enumerable:false,configurable:true});return e}());y.style={ios:h,md:x}}}}));