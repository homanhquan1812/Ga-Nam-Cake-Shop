    ...
    <div className="container">
                    ...
                    {(() => {
                        ...
                        .reverse().map((order) => (
                            !order.deleted && !order.declined && !order.delivered && (
                                ...
                                <td><button type="button" class="btn btn-danger"  data-toggle="modal" data-id={order._id} data-target="#delete-course-modal" onClick={() => handleDeleteModalShow(order._id)}>Decline</button></td>
                            </tr>
                            )
                        ))
                    })()}
        ...
        <div className="modal-dialog" role="document">
            ...
            <div className="modal-footer">
                <button id="btn-delete-course" data-dismiss="modal" type="button" className="btn btn-primary" onClick={handleDeleteOrders}>Yes</button>
