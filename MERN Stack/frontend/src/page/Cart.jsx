...
const Cart = () => {
    ...
    useEffect(() => {
        ...
        if (token) {
          ...
          setUsername(decodedToken.csw_username)
          setName(decodedToken.csw_name)
          setEmail(decodedToken.csw_emailaddress)
          setPhoneNumber(decodedToken.csw_phonenumber)
          setAddress(decodedToken.csw_address)
        }
                    ...
                    <section className="cart_item" role="list">
                        ...
                        <div className="sanPham">
                            ...
                            <div className="content_soLuong">
                                ...
                                <input className="EOdsa- v3H4Zf" type="text" role="spinbutton" aria-valuenow={1} name="quantity" defaultValue={item.qty} disabled />
                                </div>
                            </div>
                            ...
                            <div className="content_thaoTac">
                                <button className="fX1Y2g button-pink" onClick={() => deleteProduct(item._id)}>Delete</button>
                            </div>
                        </div>
                        </div>
                    </section>
