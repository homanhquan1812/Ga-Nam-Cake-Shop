    ...
    const submit = async (e) => {
      ...
      try {
        const response = await axios.put(`http://localhost:5000/staff/info/${import.meta.env.VITE_APP_API_KEY}`, {
          csw_name: name, 
          csw_phonenumber: phonenumber, 
          csw_emailaddress: email
        }, { 
          headers: { 
        ...
        if (response.data.token) {
          ...
          setDepartment(decodedToken.csw_department)
          setName(decodedToken.csw_name)
          setPhoneNumber(decodedToken.csw_phonenumber)
          setEmail(decodedToken.csw_emailaddress)
          setGender(decodedToken.csw_gender)
          setPosition(decodedToken.csw_position)
          ...
          <div className="insights">
            <div className="sales">
              ...
              <div className="form-group">
                ...
                <input type="type" className="form-control" value={department} id="phonenumber" name="phonenumber" disabled />
              </div>
              <div className="form-group">
