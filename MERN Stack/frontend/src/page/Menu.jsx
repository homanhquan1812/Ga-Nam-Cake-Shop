                ...
                product.type === "Bread" && (
                    <div className=" showcase__item BREAD " data-category="transition">
                        ...
                        <div className="showcase__info">
                            ...
                            <h4>
                                <a href={`/detail/${product._id}`}>{product.csw_products}</a>
                            </h4>
                            ...
                            <p>
                                ...
                                <button type="submit" className="btn btn-danger" onClick={() => handleAddProduct(product._id)}>Add 1 to cart</button>
                                </a>
                            <p />
                            </div>
                        </div>
